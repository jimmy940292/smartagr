...
logFolderName1 = "fishtank_20cm_dry_sand_M31_6pm/T20_"
logFolderName2 = "results/D20_B20_S1_M29/"
logFolderName3 = "rock/rock_20/T20_"

senderLogFileName = "wifi_send"
figFolder = "fig/all/wifi/"
compare = "soil_type_"
...
def draw_compare_line(expNumber):
    ...
    # ThroughputList1 = sum(ThroughputList1)/len(ThroughputList1)
    # Throughput
    ...
    plt.tight_layout()
    plt.savefig(figFolder + compare + "throughput_wifi.svg", dpi=300, bbox_inches="tight")
    plt.savefig(figFolder + compare + "throughput_wifi.eps",
    ...
    plt.yticks(fontsize=my_fontsize)
    plt.tight_layout()
    plt.savefig(figFolder +compare + "rtt_wifi.svg", dpi=300, bbox_inches="tight")
    plt.savefig(figFolder +compare + "rtt_wifi.eps", dpi=300, bbox_inches="tight")
    plt.clf()
    ...
    plt.yticks(fontsize=my_fontsize)
    plt.tight_layout()
    plt.savefig(figFolder + compare + "packetlossrate_wifi.svg",
                dpi=300, bbox_inches="tight")
    plt.savefig(figFolder + compare + "packetlossrate_wifi.eps",
                dpi=300, bbox_inches="tight")
    plt.clf()
    ...
    plt.yticks(fontsize=my_fontsize)
    plt.tight_layout()
    plt.savefig(figFolder + compare + "rssi_wifi.svg",
                dpi=300, bbox_inches="tight")
    plt.savefig(figFolder + compare + "rssi_wifi.eps",
                dpi=300, bbox_inches="tight")
    plt.clf()
