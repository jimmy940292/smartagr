...
logFolderName2 = "fishtank_20cm_300cc_sand_M31_7pm/D4B500T15_"
logFolderName3 = "fishtank_20cm_600cc_sand_M31_7pm/D4B500T15_"
logFolderName4 = "fishtank_20cm_1200cc_sand_M31_7pm/D4B500T15_"
logFolderName5 = "fishtank_20cm_2400cc_sand_M31_7pm/D4B500T15_"
...
def draw_compare_line(expNumber):
    ...
    # SnrList4 = pd.DataFram、se(SnrList4)
    # SnrList4 = SnrList4.T、s
    ...
    # Throughput
    ThroughputList = pd.DataFrame({"300cc":ThroughputList1})
    ThroughputList["600cc"] = ThroughputList2
    ThroughputList["1200cc"] = ThroughputList3
    ThroughputList["2400cc"] = ThroughputList4
    
    
    sns.lineplot(data=ThroughputList,  errorbar=('ci', 95))
    ...
    # Latency
    LatencyList = pd.DataFrame({"300cc": LatencyList1})
    LatencyList["600cc"] = LatencyList2
    LatencyList["1200cc"] = LatencyList3
    LatencyList["2400cc"] = LatencyList4

    sns.lineplot(data=LatencyList,  errorbar=('ci', 95))
    plt.xlabel("Water (ml)", fontsize=my_fontsize)
    ...
    # Packet loss rate
    packetLossList = pd.DataFrame({"300cc": packetLossList1})
    packetLossList["600cc"] = packetLossList2
    packetLossList["1200cc"] = packetLossList3
    packetLossList["2400cc"] = packetLossList4

    sns.lineplot(data=packetLossList,  errorbar=('ci', 95))
    ...
    # RSSI
    RssiList = pd.DataFrame({"300cc": RssiList1})
    RssiList["600cc"] = RssiList2
    RssiList["1200cc"] = RssiList3
    RssiList["2400cc"] = RssiList4


    sns.lineplot(data=RssiList,  errorbar=('ci', 95))
    plt.xlabel("Water (ml)", fontsize=my_fontsize)
    ...
    # SNR
    SnrList = pd.DataFrame({"300cc": SnrList1})
    SnrList["600cc"] = SnrList2
    SnrList["1200cc"] = SnrList3
    SnrList["2400cc"] = SnrList4

    sns.lineplot(data=SnrList,  errorbar=('ci', 95))
    plt.xlabel("Water (ml)", fontsize=my_fontsize)
