...
logFolderName1 = "fishtank_20cm_300cc_sand_M31_7pm/T20_"
logFolderName2 = "fishtank_20cm_600cc_sand_M31_7pm/T20_"
logFolderName3 = "fishtank_20cm_1200cc_sand_M31_7pm/T20_"
logFolderName4 = "fishtank_20cm_2400cc_sand_M31_7pm/T20_"
...
def draw_compare_line(expNumber):
    ...
    plt.savefig(figFolder + compare + "throughput_moisture_wifi.svg", dpi=300, bbox_inches="tight")
    plt.savefig(figFolder + compare + "throughput_moisture_wifi.eps",
    ...
    plt.xticks(x, labels, fontsize=my_fontsize)
    plt.yticks(fontsize=my_fontsize)
    plt.savefig(figFolder +compare + "rtt_moisture_wifi.svg", dpi=300, bbox_inches="tight")
    plt.savefig(figFolder +compare + "rtt_moisture_wifi.eps", dpi=300, bbox_inches="tight")
    plt.clf()
    ...
    plt.xticks(x, labels, fontsize=my_fontsize)
    plt.yticks(fontsize=my_fontsize)
    plt.savefig(figFolder + compare + "packetlossrate_moisture_wifi.svg",
                dpi=300, bbox_inches="tight")
    plt.savefig(figFolder + compare + "packetlossrate_moisture_wifi.eps",
                dpi=300, bbox_inches="tight")
    plt.clf()
    ...
    plt.xticks(x, labels, fontsize=my_fontsize)
    plt.yticks(fontsize=my_fontsize)
    plt.savefig(figFolder + compare + "rssi_moisture_wifi.svg",
                dpi=300, bbox_inches="tight")
    plt.savefig(figFolder + compare + "rssi_moisture_wifi.eps",
                dpi=300, bbox_inches="tight")
    plt.clf()
